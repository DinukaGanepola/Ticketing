...
define('SECRET_SALT','k2n3AfXNr8XSXzhLoAjLEMjzTVIvuhqo');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','nuwanraseeganepola@gmail.com');
...
define('DBNAME','DinLanka');
define('DBUSER','DinLanka');
define('DBPASS','dinlanka@123');

# Table prefix
define('TABLE_PREFIX','DinLanka_');
